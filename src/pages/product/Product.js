    ...
    <div className="product">
      ...
      <div className="product__top">
        ...
        <div className="product__top__right">
            <div className="product__info__top">
                <img className="product__info__image" src="https://images.unsplash.com/photo-1561808843-7adeb9606939?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="product" />
      ...
      <div className="product__bottom">
          <form action="" className="product__form">
              ...
              <div className="product__form__right"></div>
          </form>
      </div>
    </div>
  );
